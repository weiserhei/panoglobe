...
export default class Sidebar {
    ...
    addRoute(route) {
        ...
        const safeName = route.name.replace(/[^A-Z0-9]+/gi, "_") + "collapse";
        ...
        const pauseButton = mediaControlButton(
            "Pause",
            buttonClasses.concat("d-none"),
            pauseIcon
        );
        const stopButton = mediaControlButton(
            "Stop",
            buttonClasses.concat("d-none"),
            stopIcon
        );
